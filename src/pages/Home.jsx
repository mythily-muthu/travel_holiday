    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className=" flex w-[80%] h-full mx-auto">
        ...
        <div className="w-full flex absolute justify-center top-[45%] right-[12px] flex-col gap-y-4">
          <div className="bg-white flex w-[80%] mx-auto rounded-xl gap-x-[20px] py-10 px-8 justify-center">
            <div className="flex flex-col gap-y-3 w-full">
              <p className="text-gray-500 text-sm">Search your destination:</p>
              <input
                className="bg-[#F0EEF0] p-1 w-[200px] md:w-[300px] rounded-full pl-3"
            ...
            <div className="flex flex-col items-center w-full gap-y-3">
              ...
              <input type="range" className="bg-[#F0EEF0] p-1 w-[200px] md:w-[300px] rounded-full pl-3" />
            </div>
